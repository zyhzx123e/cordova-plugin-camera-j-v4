...
- (void)showCameraPicker:(NSString*)callbackId withOptions:(CDVPictureOptions *) pictureOptions
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        //cameraPicker.webView = self.webView;//Jason comment it for crash issue
...
- (void)cleanup:(CDVInvokedUrlCommand*)command
{
    @try {
     ...
     @catch (NSException *exception) {
        NSLog(@"CDVCamera trycatch cleanup err: %@", exception.reason);
     }
     @finally {
        NSLog(@"CDVCamera trycatch cleanup Finally done");
     }
...
- (void)popoverControllerDidDismissPopover:(id)popoverController
{
    @try {
     ...
     @catch (NSException *exception) {
        NSLog(@"CDVCamera trycatch popoverControllerDidDismissPopover err: %@", exception.reason);
     }
     @finally {
        NSLog(@"CDVCamera trycatch popoverControllerDidDismissPopover Finally done");
     }
}
...
- (NSData*)processImage:(UIImage*)image info:(NSDictionary*)info options:(CDVPictureOptions*)options
{
    ...
    @try {
     ...
     @catch (NSException *exception) {
        NSLog(@"CDVCamera trycatch processImage err: %@", exception.reason);
     }
     @finally {
        NSLog(@"CDVCamera trycatch processImage Finally done");
     }
...
- (NSString*)tempFilePath:(NSString*)extension
{
    ...
    @try {
     ...
     @catch (NSException *exception) {
        NSLog(@"CDVCamera trycatch tempFilePath err: %@", exception.reason);
     }
     @finally {
        NSLog(@"CDVCamera trycatch tempFilePath Finally done");
     }
...
- (UIImage*)retrieveImage:(NSDictionary*)info options:(CDVPictureOptions*)options
{
    ...
    @try {
     ...
     @catch (NSException *exception) {
        NSLog(@"CDVCamera trycatch retrieveImage err: %@", exception.reason);
     }
     @finally {
        NSLog(@"CDVCamera trycatch retrieveImage Finally done");
     }
...
- (void)resultForImage:(CDVPictureOptions*)options info:(NSDictionary*)info completion:(void (^)(CDVPluginResult* res))completion
{
    @try {
     ...
     @catch (NSException *exception) {
        NSLog(@"CDVCamera trycatch resultForImage err: %@", exception.reason);
     }
     @finally {
        NSLog(@"CDVCamera trycatch resultForImage Finally done");
     }
}
...
- (void)imagePickerController:(UIImagePickerController*)picker didFinishPickingMediaWithInfo:(NSDictionary*)info
{
    @try {
     ...
     @catch (NSException *exception) {
        NSLog(@"CDVCamera trycatch imagePickerController didFinishPickingMediaWithInfo err: %@", exception.reason);
     }
     @finally {
        NSLog(@"CDVCamera trycatch imagePickerController didFinishPickingMediaWithInfo Finally done");
     }
}
...
- (void)imagePickerController:(UIImagePickerController*)picker didFinishPickingImage:(UIImage*)image editingInfo:(NSDictionary*)editingInfo
{
    @try {
     ...
     @catch (NSException *exception) {
        NSLog(@"CDVCamera trycatch imagePickerController didFinishPickingImage editinginfo err: %@", exception.reason);
     }
     @finally {
        NSLog(@"CDVCamera trycatch imagePickerController didFinishPickingImage editinginfo Finally done");
     }
}
...
- (void)imagePickerControllerReturnImageResult
{
    @try {
     ...
     @catch (NSException *exception) {
        NSLog(@"CDVCamera trycatch imagePickerControllerReturnImageResult err: %@", exception.reason);
     }
     @finally {
        NSLog(@"CDVCamera trycatch imagePickerControllerReturnImageResult Finally done");
     }
}
